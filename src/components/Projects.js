                  ...
                  <Tab.Container id="projects-tabs" defaultActiveKey="first">
                    ...
                    >
                      <Tab.Pane eventKey="first">
                        <img src={projectImage1} alt="projectimage1" height="200" width="250" />
                        <br />
                        <p>
                      ...
                      <Tab.Pane eventKey="second">
                        <img src={projectImage2} alt="projectimage2" height="200" width="250" />
                        <br />
                        <p>
                      ...
                      <Tab.Pane eventKey="third">
                        <img src={projectImage3} alt="projectimage3" height="200" width="250" />
                        <br />
                        <p>
